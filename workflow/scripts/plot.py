...
ICE_E = np.loadtxt("ICE_transition_energies") + GS_min        # align the two energy scales
r_min = 1.2058   # the distance I took from NIST
...
data_b = np.loadtxt("data_b.csv", delimiter=",")
...
data_c = np.loadtxt("data_c.csv", delimiter=",")
